...
//================ Waiting list of sleeping threads ==============//
...
//========================insert thread into ready queue according to its priority========//
  list_insert_ordered(&ready_list,&t->elem,(list_less_func *)compare_priority
    ,NULL);
//=======================================================================================//
...
// ===================comparator for sleep time ========================= //
bool compare_wake_up_time(struct list_elem *thread1 ,
  struct list_elem *thread2, 
  void *aux UNUSED){
  const struct thread *t1,*t2;
  t1=list_entry(thread1,struct thread,elem);
  t2=list_entry(thread2,struct thread,elem);
  return t1->wait_time <= t2->wait_time;
}
//======================================================================= //
//===when thread comes to sleep insert them in wait_list_according to its sleep time====//
